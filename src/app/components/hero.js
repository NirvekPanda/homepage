...
const Hero = ({ title, paragraph }) => {
    return (
        <section className="w-5/6 max-w-5xl max-h-3xl mx-auto flex flex-col md:flex-row bg-white rounded-3xl shadow-lg min-h-[60vh] overflow-hidden border border-gray-400">
