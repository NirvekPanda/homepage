...
const Hero = ({ title, paragraph }) => {
    return (
        <section className="w-5/6 max-w-5xl max-h-3xl mx-auto flex flex-col md:flex-row bg-white/25 backdrop-blur-sm rounded-3xl shadow-lg min-h-[60vh] overflow-hidden border border-white/30">
            ...
            <div className="md:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col items-center justify-center text-center bg-white/25 backdrop-blur-sm rounded-b-3xl md:rounded-r-3xl md:rounded-bl-none text-black">
