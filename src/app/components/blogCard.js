  ...
  return (
    <>
      ...
      <div
        ...
        className="cursor-pointer relative flex flex-col my-6 bg-white/25 backdrop-blur-sm shadow-md border border-white/30 hover:border-white/50 rounded-lg w-full max-w-sm transition-all duration-100"
      >
                        {/* Image Section */}
